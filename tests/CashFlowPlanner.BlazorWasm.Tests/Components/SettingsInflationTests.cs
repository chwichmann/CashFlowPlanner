...
public sealed class SettingsInflationTests : PageTestBase
{
    ...
    public void A_fresh_plan_offers_a_rate_of_zero_and_no_base_date()
    {
        ...
        // Pinned, because MoneyInput formats through the current culture on purpose - a Swiss
        // user sees 1'234.56 and a German user 1.234,56 - so an unpinned assertion on the
        // rendered text passes or fails depending on whose machine runs it.
        WithCulture("de-CH", () =>
        {
